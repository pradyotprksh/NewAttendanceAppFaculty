...
public class FacultySaturdaySubjectRecyclerAdapter extends RecyclerView.Adapter<FacultySaturdaySubjectRecyclerAdapter.ViewHolder> {
    ...
    public FacultySaturdaySubjectRecyclerAdapter(List<FacultyMondaySubjects> subjectList, Context context) {
        this.subjectList = subjectList;
        this.context = context;
    }

    @Override
    public FacultySaturdaySubjectRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.faculty_monday_subject_list, parent, false);
        return new FacultySaturdaySubjectRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final FacultySaturdaySubjectRecyclerAdapter.ViewHolder holder, final int position) {
        ...
        if (subjectList.get(position).getWeekDay().equals("Saturday")) {
