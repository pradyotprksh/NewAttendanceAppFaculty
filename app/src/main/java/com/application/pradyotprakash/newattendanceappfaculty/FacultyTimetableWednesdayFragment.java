...
public class FacultyTimetableWednesdayFragment extends Fragment {
    ...
    private FacultyWednesdaySubjectRecyclerAdapter subjectRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_faculty_timetable_wednesday, container, false);
        mAuth = FirebaseAuth.getInstance();
        user_id = mAuth.getCurrentUser().getUid();
        mSubjectListView = view.findViewById(R.id.monday_subject);
        subjectList = new ArrayList<>();
        subjectRecyclerAdapter = new FacultyWednesdaySubjectRecyclerAdapter(subjectList, getContext());
