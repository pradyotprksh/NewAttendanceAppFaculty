...
public class FacultyTimetableSaturdayFragment extends Fragment {
    ...
    private FacultySaturdaySubjectRecyclerAdapter subjectRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_faculty_timetable_saturday, container, false);
        mAuth = FirebaseAuth.getInstance();
        user_id = mAuth.getCurrentUser().getUid();
        mSubjectListView = view.findViewById(R.id.monday_subject);
        subjectList = new ArrayList<>();
        subjectRecyclerAdapter = new FacultySaturdaySubjectRecyclerAdapter(subjectList, getContext());
