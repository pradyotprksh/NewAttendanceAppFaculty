...
public class TimetableTuesdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_timetable_tuesday, container, false);
        if (getArguments() != null) {
            classValue = getArguments().getString("class");
        }
        mSubjectListView = view.findViewById(R.id.monday_subject);
        subjectList = new ArrayList<>();
        subjectRecyclerAdapter = new TuesdaySubjectRecyclerAdapter(subjectList, getContext());
