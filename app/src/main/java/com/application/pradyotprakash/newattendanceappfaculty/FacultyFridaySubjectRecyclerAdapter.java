...
public class FacultyFridaySubjectRecyclerAdapter extends RecyclerView.Adapter<FacultyFridaySubjectRecyclerAdapter.ViewHolder> {
    ...
    public FacultyFridaySubjectRecyclerAdapter(List<FacultyMondaySubjects> subjectList, Context context) {
        this.subjectList = subjectList;
        this.context = context;
    }

    @Override
    public FacultyFridaySubjectRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.faculty_monday_subject_list, parent, false);
        return new FacultyFridaySubjectRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final FacultyFridaySubjectRecyclerAdapter.ViewHolder holder, final int position) {
        ...
        if (subjectList.get(position).getWeekDay().equals("Friday")) {
